...
public class AddUserAddress extends BaseAPI {
    ...
    public void addAddressTest(){
        ...
        Assert.assertEquals(response.jsonPath().getString("data.firstName"), FakerUtils.getFirstName());
        Assert.assertEquals(response.jsonPath().getString("data.lastName"), FakerUtils.getLastName());
